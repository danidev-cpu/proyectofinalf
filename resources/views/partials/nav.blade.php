    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="navbar-nav flex-grow-1 justify-content-end">
                ...
                <li class="nav-item pe-lg-3"> <a class="nav-link" href="{{ route('where-to-find-us') }}">Dónde estamos</a>
                </li>
                ...
                @auth
                    ...
                    <li class="nav-item">
                        <form method="POST" action="{{ route('logout') }}" style="display: inline;">
                            @csrf
                            <button class="nav-link btn btn-link" type="submit" style="border: none; padding: 0.5rem 1rem;">Salir</button>
                        </form>
                    </li>
                @else
